...
Key actions:
- Processed 12 months of trip data
- Engineered ride duration and timing features
- Identified distinct behavioral segments between rider types
...
Key actions:
- Cleaned daily and hourly Fitbit data
- Correlated activity, sleep, and caloric burn
- Audited data quality, including non-wear days
...
Key actions:
- Ingested and cleaned 1.55M synthetic user records
- Ran statistical correlation analysis in SQL
- Built dashboards on generational stress trends
